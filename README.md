...
This package is the result of discussions about what a "dream website" should be. Mister Obvious and I reminisced about a time when nearly everyone owned their own website, and aspiring Webmasters enthusiastically learned the latest design tricks and incorporated them into their pages. In those days, the Web was not dominated by a few giant corporations and self-appointed moral and thought police. There was little or no spying, tracking, selling of users' private data, censorship, demonetization, deplatforming, depersoning, or other unethical or borderline criminal behavior. Sure, "nazi admins" did exist, but their actions were localized and didn't affect public discourse to anywhere near the extent that today's megasites do. Based on those discussions, I set out to build a website that includes the best aspects of every era of online life -- dialup BBSes, online services such as AOL and CompuServe, peer-to-peer networks such as PowWow and WinMX, and social networks such as Facebook and Twitter -- with none of the negative aspects of any of those platforms. I encourage everyone who reads this to stop being victims of unscrupulous corporate media, download the package, and start their own website. It's much easier than you think. Everybody and his dog was doing it in the 1990s.

In general, the platform is specifically designed not to encourage narcissism and fame-whoring. Pursuant to that end, there is no "like" button or any other kind of voting or scoring mechanism. The expectation is that user-generated content will stand on its own merits, and that users who don't fit into the community will leave in short order. There are no "algorithms" to manipulate your endorphine levels and what-not. No facial recognition, click tracking, or other insidious means of prying into your personal life or identity. Unlike corporate social media sites, the ethical Webmasters of yore did not enage in these activities. Users will enjoy the platform because it's quirky and fun, and because they can rest easy knowing they're not going to be spied on, d0xxed, or harassed by zealots and vigilantes.
